...
**Next:** Explorer Canvas Group C — Tasks 5-7 in parallel: LOD visibility + scale band HUD, Ports of Call bookmarks, hex grid + snap. See `docs/plans/2026-02-21-explorer-canvas.md`.
