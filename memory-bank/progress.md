...
**Next:** MeBoard 2.0 — Explorer Canvas features (LOD, scale bands, procedural map gen, Ports of Call, mini-map, hex grid, fog of war, laser pointer, follow mode). See `docs/plans/2026-02-21-explorer-canvas.md`.
