...
**Next:** Explorer Canvas Task 10 — Procedural + AI expedition map generator (`expeditionMapGenerator.ts`). Then Tasks 11/12/13 (Fog of War, laser pointer, follow mode). See `docs/plans/2026-02-21-explorer-canvas.md`.
