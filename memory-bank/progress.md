...
**Explorer Canvas Group C complete (2026-02-21):** LOD visibility (Tasks 5+6) + Ports of Call (Task 7). See "Recently Added" below.
**Next:** Explorer Canvas Group D — Tasks 8 (mini-map) + 9 (hex grid + snap) in parallel. See `docs/plans/2026-02-21-explorer-canvas.md`.
